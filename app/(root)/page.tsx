...
import namanImg from "@/public/olamihero.jpg";
...
export default function IndexPage() {
  return (
    <ClientPageWrapper>
      <section className="space-y-6 pb-8 pt-6 mt-12 mb-0 md:pb-12 md:py-20 lg:py-32 h-screen flex items-center">
        <div className="container flex max-w-[64rem] flex-col items-center gap-4 text-center -mt-25">
          {/* <Link
          ...
          <div className="flex flex-col mt-10 items-center justify-center sm:flex-row sm:space-x-4 gap-3">
            <AnimatedText delay={0.6}>
              <Link
                href={"https://www.linkedin.com/in/olamidelasisi/"}
                target="_blank"
      ...
      >
        ...
        <div className="mx-auto justify-center gap-4 md:w-full lg:grid-cols-3">
          <CertificationCard certifications={featuredCertifications} />
        </div>
        <AnimatedText delay={0.4} className="flex justify-center">
          <Link href="/certifications">
            <Button variant={"outline"} className="rounded-xl">
              <Icons.certificate className="mr-2 h-4 w-4" /> View All
            </Button>
          </Link>
        </AnimatedText>
        {/* <div className="mx-auto text-center md:max-w-[58rem]">
