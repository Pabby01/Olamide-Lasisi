...
// Update the imports and profile image
import namanImg from "@/public/olamihero.jpg"; // Make sure this image exists
...
const githubUsername = "olamihero";
    ...
    <article className="container relative max-w-3xl py-6 lg:py-10">
      ...
      <div>
        ...
        <h1 className="flex items-center justify-between mt-2 font-heading text-4xl leading-tight lg:text-5xl">
          ...
          <div className="flex items-center">
            {exp.websiteLink && (
              <CustomTooltip text="View more information">
        ...
        <div className="mt-4 flex space-x-4">
          ...
          >
            ...
            <div className="flex-1 text-left leading-tight">
              <p className="font-medium">{"Olamide Lasisi"}</p>
      ...
      <div className="mb-7">
        ...
        <div className="text-sm text-muted-foreground mb-4">
          {formatDateFromObj(exp.startDate)} - {formatDateFromObj(exp.endDate)}
        </div>
      ...
      {exp.achievements && exp.achievements.length > 0 && (
        <div className="mb-7">
          ...
          <ChipContainer textArr={exp.achievements} />
        </div>
      )}
