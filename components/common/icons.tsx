import {
  ...
  AlertCircle,
  Calendar,
  Medal, // Using Scroll as alternative since Certificate is not available
  Clock,
} from "lucide-react";
...
export const Icons = {
  ...
  client: UserCheck,
  ethics: Award,
  negotiation: Scale, // Using Scale icon as fallback since HandshakeIcon is not available
